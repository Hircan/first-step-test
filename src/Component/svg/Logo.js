const Logo = (props) => {
    return (
        <svg width={props.width || "54"} height={props.height || "26"} viewBox="0 0 54 26" fill="none" xmlns="http://www.w3.org/2000/svg" className="d-flex">
            <g transform="translate(0, 26) scale(0.1,-0.1)" fill={props.color || "black"} stroke="none">
                <path
                    d="M180 235 c0 -9 9 -15 25 -15 14 0 25 -5 25 -10 0 -6 -11 -16 -25 -22
